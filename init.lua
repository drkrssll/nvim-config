...
-- Create an autocommand group to manage settings for specific file types
vim.api.nvim_create_autocmd('FileType', {
  pattern = 'javascriptreact', -- This applies to .jsx files
  callback = function()
...
local function setup_custom_highlights()
  ...
  vim.api.nvim_set_hl(0, 'Normal', { fg = palette.white, bg = palette.amber_shadow })
...
--  bright_red = '#D42B29',
--  bright_green = '#E92825',
--  bright_yellow = '#BD5D5E',
--  bright_blue = '#868080',
--  bright_magenta = '#A3A2A2',
--  bright_cyan = '#CBB7B7',
--  bright_white = '#e1e0e0',
--}
--
...
--vim.api.nvim_set_hl(0, 'StatusLineNC', { fg = colors.bright_black, bg = colors.bg })
--vim.api.nvim_set_hl(0, 'TabLine', { fg = colors.fg, bg = colors.black })
--vim.api.nvim_set_hl(0, 'TabLineSel', { fg = colors.fg, bg = colors.red })
--vim.api.nvim_set_hl(0, 'TabLineFill', { fg = colors.bright_black, bg = colors.bg })
--vim.api.nvim_set_hl(0, 'Visual', { fg = colors.fg, bg = colors.bright_black })
--vim.api.nvim_set_hl(0, 'Pmenu', { fg = colors.fg, bg = colors.black })
--vim.api.nvim_set_hl(0, 'PmenuSel', { fg = colors.bg, bg = colors.bright_red })

--local function set_custom_highlights()
--  local custom_highlights = {
--    -- Syntax elements
--    ['@keyword'] = { fg = '#F371FF' }, -- Keywords (if, else, function, etc.)
--    ['@string'] = { fg = '#3DDF34' }, -- String literals
--    ['@number'] = { fg = '#BD93F9' }, -- Numbers
--    ['@function'] = { fg = '#8BE9FD' }, -- Function names
--    ['@function.builtin'] = { fg = '#FFB86C' }, -- Built-in functions
--    ['@variable'] = { fg = '#F8F8F2' }, -- Variables
--    ['@parameter'] = { fg = '#FF6219' }, -- Function parameters
--    ['@type'] = { fg = '#FFB86C' }, -- Types
--    ['@comment'] = { fg = '#6272A4' }, -- Comments
--    ['@operator'] = { fg = '#FF79C6' }, -- Operators
--    ['@punctuation'] = { fg = '#F8F8F2' }, -- Punctuation
--    ['@attribute'] = { fg = '#FF79C6' },
--
--    -- Additional elements
--    ['@constant'] = { fg = '#BD93F9' }, -- Constants
--    ['@property'] = { fg = '#FFB86C' }, -- Object properties
--    ['@constructor'] = { fg = '#50FA7B' }, -- Constructors
--    ['@conditional'] = { fg = '#FF79C6' }, -- Conditionals (if, else)
--    ['@repeat'] = { fg = '#FF79C6' }, -- Loops (for, while)
--    ['@exception'] = { fg = '#FF5555' }, -- Exception keywords
--
...
--end
--
---- Apply custom highlights when colorscheme changes
----vim.api.nvim_create_autocmd('ColorScheme', {
----  callback = set_custom_highlights,
----})
--
---- Set your preferred colorscheme
----vim.cmd [[colorscheme dracula]] -- Replace with your preferred base colorscheme
--
---- Apply the custom highlights immediately
